...
import { useSelector } from 'search/state'
import { toast } from 'react-toastify'

import { Interaction, Query, QueryResult, QueryResultStatuses } from 'search/features/query'

import { cache } from 'search/api/result'
import { state2Query } from 'search/features/query'
...
export const QueryResultCard = () => {
    const query = useSelector(state2Query)
...
const CardFetcher: React.FC<FetcherProps> = ({ query }) => {
